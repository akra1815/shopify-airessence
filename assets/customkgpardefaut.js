...
if (inputvalcart <= 1) {
    ...
    kgecotxt.innerHTML = '<strong class="strongparaquant">Ajoutez des sent-bon pour obtenir des réductions !</strong><br>Aussi cumulable avec d\'autres modèles.';  
...
document.querySelector("label.quantity__label").innerHTML = "" + txtqtykg;
